...
async function getRequest(){
    ...
    try {
        const response = await fetch (`https://simple-ppg.herokuapp.com/api/${charName}`) // have to use template literal in to get api from url
    ...
    //display information
    document.querySelector('h1').innerText = data.charName
