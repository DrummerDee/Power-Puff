...
const buttercup = new Char('Buttercup', 'She has none', 'Black', 'Flight,Super Strength,FireBalls', 'Mojo Jojo, Ruffle ToughEm Boys, Him', `Yeah, but it's a skill that you can't do`, 'E.G Daily'),
  ...
  princessmorbucks = new Char('Princess Morbucks','yellow Powerpuff-style dress,black gloves,boots,and a tiara','Had powers similar to PPG at one point','The PowerPuff Girls',`"Why, you - you can't do this to me! I'm the Princess! Do you know who my daddy is?`,'Jennifer Hale',),
